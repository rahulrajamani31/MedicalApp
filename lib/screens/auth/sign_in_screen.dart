...
import 'package:medicalpat/screens/auth/sign_up_screen.dart';
import 'package:medicalpat/screens/auth/home.dart';
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          var response =
                              await networkHandler.post("puser/login", data);
                          if (response.statusCode == 200 ||
                            ...
                            Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => BottomNavyBarExample(),
                                ),
                                (route) => false);
                          } else {
